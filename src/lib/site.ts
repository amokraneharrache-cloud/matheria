...
export const publicSeoRoutes = [
  ...
  "/demonstrations-bac-maths-terminale",
  ...
  "/grand-oral-maths-2027",
  "/sujets-grand-oral-maths",
  "/questions-jury-grand-oral-maths",
  "/sujets-type-bac-maths-terminale",
  "/exercices-type-bac-maths-terminale",
  "/annales-bac-maths-terminale",
  "/annales-bac-maths-par-chapitre",
  "/sujet-bac-maths-2024-corrige",
  "/sujet-bac-maths-2025-corrige",
  "/sujet-bac-maths-2026-corrige",
  "/bac-terminale-maths",
  "/bac-premiere-maths",
  "/epreuve-anticipee-maths-premiere",
  "/sujets-zero-maths-premiere",
  "/automatismes-maths-premiere",
  "/formules-maths-premiere-specialite",
  "/quiz-maths-premiere-specialite",
  "/exercices-epreuve-anticipee-maths-premiere",
  "/sujet-epreuve-anticipee-maths-2026-corrige",
  "/brevet-maths",
  ...
  "/programme-maths-terminale/integrales",
  ...
  "/methodes-maths-terminale/integrales",
  ...
  "/exercices-maths-terminale/integrales",
