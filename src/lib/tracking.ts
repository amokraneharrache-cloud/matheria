...
export type SprintMathsEventName =
  ...
  | "click_planning_success_diagnostic"
  | "click_planning_success_subjects"
  | "click_planning_success_typebac"
  | "click_planning_success_offer"
  ...
  | "click_subject_complete_2_typebac_start"
  | "click_subject_complete_2_chapter_link"
  | "click_subject_complete_2_planning"
  | "click_subject_complete_2_diagnostic"
  | "click_subject_complete_2_offer"
  | "click_subject_complete_2_first_subject"
  | "free_exercise_start"
